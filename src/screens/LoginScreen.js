    ...
    return (
        <View style={styles.container}>
            <View style={{ flex: 0.60, alignItems: 'center', justifyContent: 'center' }}>
                <Image style={{ height: '100%', width: '100%', resizeMode: 'contain', marginTop: 20 }} source={require('../images/logo.png')} />
            </View>
            <View style={{ flex: 1, alignItems: 'center' }}>
                ...
                <View style={{ flex: 1 }}>
                    <TouchableOpacity onPress={() => navigation.navigate('register')}>
                        <Text style={{ fontSize: 18, color: '#f4a259', fontWeight: 'bold', textAlign: 'left' }}>Créer un compte</Text>
                        </TouchableOpacity>
                </View>
                </View>
            </View>
